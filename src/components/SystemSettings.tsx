    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Currency and financial calculation preferences</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {settings.filter(s => s.category === "Financial").map((setting) => (
            <div key={setting.id} className="flex items-center justify-between py-2">
              <div className="flex-1 mr-4">
                <Label className="text-sm font-medium">{setting.key.replace(/_/g, " ")}</Label>
                <p className="text-xs text-gray-600">{setting.description}</p>
              ...
              <div className="w-64">
                <Select value={setting.value} onValueChange={(value) => handleSettingChange(setting.id, value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="PGK">Papua New Guinea Kina (PGK)</SelectItem>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Default map configurations and display options</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {settings.filter(s => s.category === "Maps").map((setting) => (
            <div key={setting.id} className="flex items-center justify-between py-2">
              <div className="flex-1 mr-4">
                <Label className="text-sm font-medium">{setting.key.replace(/_/g, " ")}</Label>
                <p className="text-xs text-gray-600">{setting.description}</p>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configure system security policies and access controls</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
            ...
            <div key={setting.id} className="flex items-center justify-between py-3 border-b last:border-b-0">
              <div className="flex-1 mr-4">
                <div className="flex items-center gap-2">
                  ...
                  <Badge className={getSecurityLevelColor(setting.level)} variant="secondary">
                    {setting.level}
                  </Badge>
                </div>
            ...
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">admin@doworks.gov.pg • 2025-01-09 08:30</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">System configuration changed • 2025-01-08 14:22</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">unknown@example.com • 2025-01-08 09:15</div>
                </div>
              </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Configure system preferences, users, and security settings</p>
        </div>
      </div>
        ...
        <TabsContent value="notifications" className="space-y-6">
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-600 mb-4">Configure email notifications, alerts, and messaging preferences</p>
